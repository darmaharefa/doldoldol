					...
					<div class="col-md-12 bg-white">
						<div class="content">
							<div class="content center pad10p">
								...
								<button type="button" class="btn btn-success widthfull noborder top4p">
								<i class="glyphicon glyphicon-plus"></i> Follow
								</button>
								<button type="button" class="btn btn-default widthfull noborder top4p">
								<i class="glyphicon glyphicon-envelope"></i> Kirim Pesan
								</button>
							</div>
						</div>
					</div>
